...
$lista = ControllerCliente::buscarClientePorId($_GET['id']);
?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col2">
                    <a href="editaClientes.php" class="btn btn-primary">Editar Cliente</a>
                </div>
                <br>
                <table class="table table-hover">
                    ...
                    foreach($lista as $cliente){
                        echo "<tr>";
                        echo "<td width=\"20%\">" . $cliente->getNome() . "</td>";
                        echo "<td width=\"20%\">" . $cliente->getEmail() . "</td>";
                        echo "<td width=\"20%\">" . $cliente->getTelefone() . "</td>";
                        echo "<td width=\"20%\">" . $cliente->getEndereco() . "</td>";
                        echo "<td width=\"20%\">" . $cliente->getSexo() . "</td>";
                        echo "<td width=\"20%\">" . $cliente->getProfissao() . "</td>";
